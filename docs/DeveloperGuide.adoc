...
4.  EatMe prompts user to shift the eatery under the main mode (of visited places)
5.  User approves of the shift
6.  EatMe shifts the data over
7.  EatMe toggles to the main mode
8.  EatMe requests user for whatever information left that is required before saving in the main mode
+
Use case ends.
...
+
[none]
** 5a1. EatMe deletes the eatery from todolist.
+
Use case ends.

* 8a. The given information is of the wrong format.
+
[none]
** 8a1. EatMe shows an error message.
+
