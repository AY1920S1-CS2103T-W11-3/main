= Balam Sai Rohit - Project Portfolio Page
...
dishes that they relinquished, and also stay up to date with the latest trends in the world of food.
Users interact with it using a Command Line Interface (CLI) and it also has a Graphical User Interface (GUI)
created with JavaFX. The application is written in Java and has about 10 kLoC.
...
** Updated the User Guide with new information.
** Updated the Developer Guide with new information and diagrams.
