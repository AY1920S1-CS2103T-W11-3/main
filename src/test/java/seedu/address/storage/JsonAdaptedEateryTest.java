...
public class JsonAdaptedEateryTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedEatery eatery =
                new JsonAdaptedEatery(INVALID_NAME, VALID_ISOPEN, VALID_ADDRESS, VALID_CATEGORY,null,  VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedEatery eatery = new JsonAdaptedEatery(null, VALID_ISOPEN, VALID_ADDRESS, VALID_CATEGORY, null, VALID_TAGS);
    ...
    public void toModelType_invalidIsOpen_throwsIllegalValueException() {
        JsonAdaptedEatery eatery =
                new JsonAdaptedEatery(VALID_NAME, INVALID_ISOPEN, VALID_ADDRESS, VALID_CATEGORY, null, VALID_TAGS);
    ...
    public void toModelType_nullIsOpen_throwsIllegalValueException() {
        JsonAdaptedEatery eatery = new JsonAdaptedEatery(VALID_NAME, null, VALID_ADDRESS, VALID_CATEGORY, null, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedEatery eatery =
                new JsonAdaptedEatery(VALID_NAME, VALID_ISOPEN, INVALID_ADDRESS, VALID_CATEGORY, null, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedEatery eatery = new JsonAdaptedEatery(VALID_NAME, VALID_ISOPEN, null, VALID_CATEGORY, null, VALID_TAGS);
    ...
    public void toModelType_invalidCategory_throwsIllegalValueException() {
        JsonAdaptedEatery eatery =
                new JsonAdaptedEatery(VALID_NAME, VALID_ISOPEN, VALID_ADDRESS, INVALID_CATEGORY, null, VALID_TAGS);
    ...
    public void toModelType_nullCategory_throwsIllegalValueException() {
        JsonAdaptedEatery eatery = new JsonAdaptedEatery(VALID_NAME, VALID_ISOPEN, VALID_ADDRESS, null, null, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedEatery eatery =
                new JsonAdaptedEatery(VALID_NAME, VALID_ISOPEN, VALID_ADDRESS, VALID_CATEGORY, null, invalidTags);
